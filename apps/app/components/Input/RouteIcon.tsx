        ...
        return <Tooltip delayDuration={200}>
            <TooltipTrigger asChild >
                <div className="absolute -left-1 top-0.5 z-50">
                    <Info className="!w-4 text-primary-text-tertiary hover:text-primary-text icoooooooooon" />
                </div>
            </TooltipTrigger>
            <TooltipContent>
        ...
        return <Tooltip delayDuration={200}>
            <TooltipTrigger asChild >
                <div className="absolute -left-0.5 top-0.5 z-50">
                    <RouteOff className="!w-3 text-primary-text-tertiary hover:text-primary-text icoooooooooon" />
                </div>
            </TooltipTrigger>
            <TooltipContent>
                <p className="max-w-72">
