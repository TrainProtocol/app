...
const Widget = ({ children, className, hideMenu }: Props) => {
   ...
   return <>
      <div id='widget' className={`bg-secondary-700 md:shadow-md border border-border rounded-3xl w-full sm:overflow-hidden has-expandContainerHeight:min-h-[675px] max-sm:has-openpicker:min-h-svh max-sm:min-h-[99.8svh] sm:has-openpicker:min-h-[79svh]! sm:min-h-[408px] relative`}>
