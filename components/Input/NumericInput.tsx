            ...
            <div className="flex relative w-full">
                <input
                    ...
                    className={classNames(
                        'disabled:cursor-not-allowed h-12 leading-4 shadow-sm border-transparent placeholder:text-primary-text-tertiary bg-secondary-700 focus:ring-transparent focus:border-primary block min-w-0 rounded-xl font-semibold border',
                        className
                    )}
