...
const AmountField = forwardRef(function AmountField(_, ref: any) {
    ...
    //     if (((native_currency === fromCurrency?.symbol) || !native_currency) && ((walletBalance.amount - gasAmount) >= Number(minAllowedAmount) && (walletBalance.amount - gasAmount) <= Number(maxAmountFromApi))) {
