            ...
            {isActive && (
                <>
                    <div
                        ...
                        style={{
                            animationDelay: "0s", clipPath: "inset(0 -8px 70% -8px)", boxShadow: `
                    ...
                    <div
                        ...
                        style={{
                            animationDelay: "0.6s", clipPath: "inset(0 -8px 60% -8px)", boxShadow: `
                            rgba(128, 128, 128, 0.7) 6px -4px 14px -2px, rgba(128, 128, 128, 0.7) -5px 1px 12px 0px, rgba(128, 128, 128, 0.7) 6px 0px 11px 1px inset, rgba(128, 128, 128, 0.7) -6px 0px 11px 1px inset 
                        ` }}
                    ></div>
                    <div
                        ...
                        style={{
                            animationDelay: "1.2s", clipPath: "inset(0 -15px 55% -15px)", boxShadow: `
                            rgba(128, 128, 128, 0.7) 6px -4px 14px -2px, rgba(128, 128, 128, 0.7) -5px 1px 12px 0px, rgba(128, 128, 128, 0.7) 6px 0px 11px 1px inset, rgba(128, 128, 128, 0.7) -6px 0px 11px 1px inset 
                        ` }}
                    ></div>
                    <div
                        ...
                        style={{
                            animationDelay: "1.8s", clipPath: "inset(0 -15px 50% -15px)", boxShadow: `
                            rgba(128, 128, 128, 0.7) 6px -4px 14px -2px, rgba(128, 128, 128, 0.7) -5px 1px 12px 0px, rgba(128, 128, 128, 0.7) 6px 0px 11px 1px inset, rgba(128, 128, 128, 0.7) -6px 0px 11px 1px inset 
                        ` }}
                    ></div>
                    <div
