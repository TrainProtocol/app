...
const ButtonStatus: FC<Props> = ({ isDisabled, isLoading, children }) => {
    return (
        <div
            className={clsx('items-center space-x-1 relative w-full flex justify-center font-semibold rounded-componentRoundness transition duration-200 ease-in-out bg-secondary-500 text-primary-text py-3 px-2 md:px-3 cursor-progress', {
