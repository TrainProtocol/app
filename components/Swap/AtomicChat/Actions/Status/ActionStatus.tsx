...
const resolveIcon = (status: "pending" | "success" | "error") => {
    switch (status) {
        case "pending":
            return <>
                <div className='absolute top-1 left-1 w-4 h-4 md:w-5 md:h-5 opacity-40 bg-accent rounded-full animate-ping'></div>
                <div className='absolute top-2 left-2 w-2 h-2 md:w-3 md:h-3 opacity-40 bg-accent rounded-full animate-ping'></div>
