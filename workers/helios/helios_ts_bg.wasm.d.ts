...
export function ethereumclient_get_block_by_hash(a: number, b: number, c: number, d: number): number;
export function ethereumclient_get_code(a: number, b: number, c: number): number;
export function ethereumclient_get_storage_at(a: number, b: number, c: number, d: number): number;
...
export function ethereumclient_get_filter_changes(a: number, b: number): number;
export function ethereumclient_get_filter_logs(a: number, b: number): number;
export function ethereumclient_uninstall_filter(a: number, b: number): number;
export function ethereumclient_new_filter(a: number, b: number): number;
export function ethereumclient_new_block_filter(a: number): number;
export function ethereumclient_new_pending_transaction_filter(a: number): number;
...
export function opstackclient_get_block_by_hash(a: number, b: number, c: number, d: number): number;
export function opstackclient_get_code(a: number, b: number, c: number): number;
export function opstackclient_get_storage_at(a: number, b: number, c: number, d: number): number;
...
export function opstackclient_get_filter_changes(a: number, b: number): number;
export function opstackclient_get_filter_logs(a: number, b: number): number;
export function opstackclient_uninstall_filter(a: number, b: number): number;
export function opstackclient_new_filter(a: number, b: number): number;
export function opstackclient_new_block_filter(a: number): number;
export function opstackclient_new_pending_transaction_filter(a: number): number;
export function opstackclient_client_version(a: number): number;
export function __wbindgen_malloc(a: number, b: number): number;
export function __wbindgen_realloc(a: number, b: number, c: number, d: number): number;
export const __wbindgen_export_2: WebAssembly.Table;
export const __wbindgen_export_3: WebAssembly.Table;
export function closure276_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1e7a0f184f3962eb(a: number, b: number): void;
export function __externref_table_dealloc(a: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function __externref_table_alloc(): number;
export function closure215_externref_shim(a: number, b: number, c: number, d: number): void;
